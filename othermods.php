...
<table width="775" align="center" cellpadding="7" cellspacing="7" border="0" bordercolor="#0000ff" >
	<tr>
		<td class="sixsix" colspan="2"><font class="newtitle">Other MOD's. In other words MOD's I've been to lazy to make pages for :P</font>
		</td>
			...
			if ($lookingfordashtoend2 == "/")
				{
					...
					//how do do an if to campare one variable against multips
					if(($modclassis=="saab")||($modclassis=="st")||($modclassis=="sw")||($modclassis=="bg")||($modclassis=="fs")||($modclassis=="hw")||($modclassis=="other"))
						{
/*
end usrnm parsing
*/
...
*/
							...
							if ($lookingfordashtoend3 == "/")
								{
									$smshipis=substr("$filepath4",0,$countingtilldash3-1);
									...
									//echo "smshipis&nbsp;&nbsp;&nbsp;"; //echo $smshipis; //echo"<BR>";
...
*/
									...
									//echo"this is a Fighter";//echo $smshipis;//echo"<BR>";
									$countingtilldash4=0;
