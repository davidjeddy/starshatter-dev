...
<? $forum = "SC to SS" ?>
<tr>
<td colspan="5" align="left" nowrap class="sixsix"><font class="newtitle">Welcome to the Starcraft to Starshatter MOD forum, <?php echo $author ?> </font>
<BR>
	<a href="../../comm.php" class="bigyellow">FORUMS</a> | 
	<a href="main.php" class="bigyellow">Main</a> | 
	<a href="login.php" class="shipdesigners">Login</a> | 
	<a href="edit_profile.php?newauthor=true" class="shipdesigners">Register</a> | 
	<a href="edit_profile.php" class="shipdesigners">Profile</a> | 
	<a href="post.php?action=new" class="shipdesigners">New thread</a>
</td>
</tr>
