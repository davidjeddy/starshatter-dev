...
<table width="775" align="center" cellpadding="7" cellspacing="7" border="0" bordercolor="#0000ff" >
	<tr>
		<td class="sixsix" colspan="2"><font class="newtitle">Mission / Campagin DEF's. Text files that will drive you nuts.</font>
		</td>
...
*/
					...
					if ($lookingfordashtoend3 == "/")
						{
							$mission=substr("$filepath4",0,$countingtilldash3-1);
							//echo "mission before username strip&nbsp;&nbsp;&nbsp;"; //echo $filepath4; //echo"<BR>";
							$filepath5=substr("$filepath4",$countingtilldash3,128);
							//echo "path is after username strip&nbsp;&nbsp;&nbsp;"; //echo $filepath5; //echo"<BR>";
							//echo "middion&nbsp;&nbsp;&nbsp;"; //echo $mission; //echo"<BR>";
							//echo"we did good dropping the middion<BR><BR><BR><BR>";
/*
...
*/
							...
							//echo"this is a mission:  ";//echo $mission;//echo"<BR>";
							/*$countingtilldash4=0;
							...
							if ($lookingfordashtoend4 == "/")
								{
									...
									*/
									...
									//echo "<BR><BR><BR>";
									if($mission=="MissionDEF")
										{
											include("$filenames");
										}
									//echo "<BR><BR><BR>";
									if($mission=="CampaginDEF")
										{
											include("$filenames");
										}
									if($mission=="ShipDEF")
