...
Layout =
	{
		writeStyleSelect : function ()
			{
				document.write("\
<a href=\"#\" style=\"font:10px verdana;text-decoration:underline;\" onClick=\"setActiveStyleSheet('main'); return false;\">Yellow & Black</a><BR>\
<a href=\"#\" style=\"font:10px verdana;text-decoration:underline;\" onClick=\"setActiveStyleSheet('windef'); return false;\">Win's Default</a><BR>\
<a href=\"#\" style=\"font:10px verdana;text-decoration:underline;\" onClick=\"setActiveStyleSheet('aqublu'); return false;\">Aqua & Blues</a><BR>\
");
			}
	};
...
{
	effect = "Fade(duration=0.5);Alpha(style=0,opacity=75);Shadow(color='#ffff00', Direction=210, Strength=5)"
}
else
{
	effect = "Shadow(color='#777777', Direction=210, Strength=5)" // Stop IE5.5 bug when using more than one filter
}


timegap=500				// The time delay for menus to remain visible
followspeed=7			// Follow Scrolling speed
followrate=7			// Follow Scrolling Rate
...
9,					// Menu Left - The Left position of the menu in pixels
65,					// Menu Width - Menus width in pixels
1,					// Menu Border Width 
"right:top",					// Screen Position - here you can use "center;left;right;middle;top;bottom" or a combination of "center:middle"
...
,"Change&nbsp;SSD&nbsp;Apprance","show-menu=styles",,"",1
])


	addmenu(menu=["styles",,,100,1,"",style1,,"",effect,,,,,,,,,,,,
	,"<SCRIPT type=text/javascript>Layout.writeStyleSelect();</SCRIPT>","",,,1
	])
...
{		
	...
	if(ltype=="form"||hlnk=="#"||ltype=="header"){mp="default";if(ns4){hlnk="<a ";}else{hlnk=" "}}else{if(ns4){hlnk="<a href=\""+hlnk+"\" "+ltarg}else{hlnk="<a href=\""+hlnk+"\" "+ltarg + " >"}}
