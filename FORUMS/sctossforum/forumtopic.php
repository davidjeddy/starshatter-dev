<?php
  ...
  function forum_loadTopics() {
    ...
    $topic     = array();
    $topicFile = $HTTP_SERVER_VARS["DOCUMENT_ROOT"] . '/ssd/forums/data/sctoss.php-topics.txt';
    $fp        = 0;
  ...
  function forum_loadThread($index) {
    ...
    $thread     = array();
    $threadFile = $HTTP_SERVER_VARS["DOCUMENT_ROOT"] . '/ssd/forums/data/sctoss.php-' . $index . '.txt';
    $fp         = 0;
